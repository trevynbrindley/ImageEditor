...
public class InputManager implements InputProcessor {
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        Rec2D rectangleTwo = new Rec2D(
                ...
                Color.GREEN);
                Rec2D collision = CollisionManager.Instance.getCollision(new Vector2(screenX, ImageEditor.ScreenSize.y - screenY));
                if(collision == ImageEditor.Instance.button1) System.out.println("Pressed button 1");
                else if(collision == ImageEditor.Instance.button2) System.out.println("Pressed button 2");
        return true;
    }
